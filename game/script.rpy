...
label robot_isnt_complete_defence:
    #Председатель комиссии:
    "Молодой человек, ваш робот выглядит впечатляюще. Но главный вопрос: какую практическую пользу он может принести?"

    #Марк:
    "Спасибо за вопрос. Мой робот предназначен для мониторинга и диагностики оборудования в труднодоступных местах. Например, на производственных линиях или в вентиляционных системах."

    #Второй член комиссии:
    "И как он справляется с непредвиденными препятствиями?"

    #Марк:
    "Продемонстрируй обход препятствий."

    #робот
    "(Робот плавно объезжает внезапно поставленный на его пути стул, затем возвращается на позицию.)- И"

    #Третий член комиссии:
    "А энергопотребление? В записке указано 8 часов автономной работы."

    #Марк:
    "Это подтверждено тестами. Использованы литий-полимерные аккумуляторы и система оптимизации энергозатрат. Робот может работать полную рабочую смену без подзарядки."

    #Председатель комиссии:
    "Что насчёт расширяемости функционала?"

    #Марк:
    "Конструкция модульная. Можно устанавливать дополнительное оборудование — тепловизоры, газоанализаторы, манипуляторы. Это делает робота универсальной платформой для разных задач."

    "(После успешной демонстрации всех функций)"

    #Председатель комиссии:
    "(обращаясь к комиссии)Коллеги, я считаю, мы увидели качественную проработанную работу. Соответствует всем заявленным характеристикам."

    #коммисия
    "Комиссия единогласно ставит высший балл."
    ...
    "Знаете, что самое удивительное? Он продолжает совершенствоваться. Анализирует свои действия и оптимизирует алгоритмы."

    #Робот:

    "Все текущие задачи выполнены. Готов к новым."
